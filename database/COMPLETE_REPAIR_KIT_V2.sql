-- ============================================================
-- 🚑 [긴급 복구 키트 v2] 통합 해결 스크립트 + 오버로딩 지원
-- 1. 500 에러 (무한 루프) 해결
-- 2. 권한 변경 함수 (RPC) 최신화 + 구버전 호환성 지원 (오버로딩)
-- 3. 슈퍼 관리자 계정 복구
-- ============================================================
...
DROP POLICY IF EXISTS "user_profiles_insert" ON public.user_profiles; -- 혹시 모를 정책 삭제
...
SELECT '✅ 통합 복구 v2 완료 (모든 RPC 호환성 지원)' AS result;
