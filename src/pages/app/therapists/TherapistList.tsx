    ...
    return (
        <div className="space-y-6 pb-20 p-4 md:p-8 bg-slate-50/50 dark:bg-slate-950 min-h-screen">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-4 md:mb-8 gap-3 md:gap-4">
                <div>
                    <h1 className="text-xl md:text-3xl font-black text-slate-900 dark:text-white">직원 및 권한 관리</h1>
                    <p className="text-xs md:text-base text-slate-500 dark:text-slate-400 font-bold mt-1">
                ...
                <div className="flex flex-wrap gap-2 w-full md:w-auto">
                    <div className="bg-white dark:bg-slate-900 p-1 rounded-xl border border-slate-200 dark:border-slate-800 flex shadow-sm">
                        <button
                            ...
                            className={cn(
                                "px-3 md:px-4 py-1.5 md:py-2 text-xs md:text-sm font-bold rounded-lg transition-all",
                        ...
                        <button
                            ...
                            className={cn(
                                "px-3 md:px-4 py-1.5 md:py-2 text-xs md:text-sm font-bold rounded-lg transition-all flex items-center gap-1 md:gap-2",
                        ...
                        >
                            ...
                            <span className="hidden md:inline">퇴사자 창고</span>
                            <span className="md:hidden">퇴사</span>
                        </button>
                    </div>
                    ...
                    <button
                        ...
                        className="bg-indigo-600 text-white px-3 md:px-5 py-2 md:py-3 rounded-xl md:rounded-2xl font-bold flex items-center gap-1.5 md:gap-2 transition-all hover:bg-indigo-700 shadow-lg shadow-indigo-200 text-xs md:text-sm whitespace-nowrap"
                    >
                        <Plus className="w-4 h-4 md:w-5 md:h-5" /> 치료사
                    </button>
                    <button
                        onClick={() => {
                            setEditingId(null);
                        ...
                        className="bg-rose-100 text-rose-600 px-3 md:px-5 py-2 md:py-3 rounded-xl md:rounded-2xl font-bold flex items-center gap-1.5 md:gap-2 transition-all hover:bg-rose-200 border border-rose-200 text-xs md:text-sm whitespace-nowrap"
                    >
                        <Shield className="w-4 h-4 md:w-5 md:h-5" /> 관리자
                    </button>
                    <button
                        onClick={() => {
                            setEditingId(null);
                        ...
                        className="bg-amber-100 text-amber-700 px-3 md:px-5 py-2 md:py-3 rounded-xl md:rounded-2xl font-bold flex items-center gap-1.5 md:gap-2 transition-all hover:bg-amber-200 border border-amber-200 text-xs md:text-sm whitespace-nowrap"
                    >
                        <UserCog className="w-4 h-4 md:w-5 md:h-5" /> 매니저
                    </button>
                </div>
            </div>
